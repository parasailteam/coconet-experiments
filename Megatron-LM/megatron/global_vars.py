...
class _Timer:
    ...
    def stop(self):
        ...
        torch.cuda.synchronize()
        _t = self.start_event.elapsed_time(self.end_event) / 1000.0
        self.elapsed_ += _t #(self.start_event.elapsed_time(self.end_event) / 1000.0)
        self.started_ = False
        # if torch.distributed.get_rank() == 0:
        #     print(self.name_, self.elapsed_, _t)
