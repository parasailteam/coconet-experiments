...
gpt3_baseline = execute_command_and_get_result("AR-C", "bert", bert_training_data)
gpt3_overlap = execute_command_and_get_result("overlap", "bert", bert_training_data)

print ("\n\nPipeline Parallel Inference Improvements:")
print ("GPT2 Imprvement: ", gpt2_baseline/gpt2_overlap)
print ("GPT3 Imprvement: ", gpt3_baseline/gpt3_overlap)
