...
def _add_distributed_args(parser):
    ...
    group.add_argument('--partition', nargs='+', default=[], help="type array seperated with space, as input to place each amount of transformers into each pipeline parallel stages")
    return parser
