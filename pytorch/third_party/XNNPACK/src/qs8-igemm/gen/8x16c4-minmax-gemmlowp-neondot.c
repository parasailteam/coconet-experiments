    ...
    const union xnn_qs8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_DISABLE_TSAN XNN_DISABLE_MSAN
{
  ...
  do {
    ...
    const int32x4_t vproduct6x0123 = vqrdmulhq_s32(vacc6x0123, vmultiplier);
    const int32x4_t vproduct6x4567 = vqrdmulhq_s32(vacc6x4567, vmultiplier);
    const int32x4_t vproduct6x89AB = vqrdmulhq_s32(vacc6x89AB, vmultiplier);
    const int32x4_t vproduct6xCDEF = vqrdmulhq_s32(vacc6xCDEF, vmultiplier);
    const int32x4_t vproduct7x0123 = vqrdmulhq_s32(vacc7x0123, vmultiplier);
    const int32x4_t vproduct7x4567 = vqrdmulhq_s32(vacc7x4567, vmultiplier);
    const int32x4_t vproduct7x89AB = vqrdmulhq_s32(vacc7x89AB, vmultiplier);
    const int32x4_t vproduct7xCDEF = vqrdmulhq_s32(vacc7xCDEF, vmultiplier);
