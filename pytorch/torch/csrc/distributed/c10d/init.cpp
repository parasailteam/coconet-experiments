...
:func:`reduce`, :func:`all_reduce_multigpu`, etc.)")
  ...
  auto processGroup =
      shared_ptr_class_<::c10d::ProcessGroup>(module, "ProcessGroup")
         ...
         .def(
              "overlap_matmul_allreduce_bias_dropout_layernorm",
              &::c10d::ProcessGroup::overlap_matmul_allreduce_bias_dropout_layernorm,
              py::arg("input"),
              py::arg("w"),
              py::arg("bias"),
              py::arg("add_tensor"),
              py::arg("output"),
              py::arg("normalizationDimSize"),
              py::arg("opts") = ::c10d::AllreduceOptions(),
              py::call_guard<py::gil_scoped_release>())

         .def(
              "model_parallel_update",
              &::c10d::ProcessGroup::model_parallel_update,
              py::arg("input_"),
              py::arg("bias"),
              py::arg("add_tensor"),
              py::arg("opts") = ::c10d::AllreduceOptions(),
          ...
          .def(
              "model_parallel_update_with_layer_norm",
              &::c10d::ProcessGroup::model_parallel_update_with_layer_norm,
              py::arg("input_"),
              py::arg("bias"),
              py::arg("add_tensor"),
              py::arg("normalizationDimSize"),
          ...
          .def(
              "coconetLayerNorm",
              &::c10d::ProcessGroup::coconetLayerNorm,
              py::arg("input_"),
              py::arg("normalizationDimSize"),
